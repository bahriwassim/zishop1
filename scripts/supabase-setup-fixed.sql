-- Script de configuration complète pour Supabase ZiShop (VERSION CORRIGÉE)
...
-- ==================================================
-- 7. CONFIGURATION DES AUTORISATIONS (SANS RLS)
-- ==================================================

-- Donner des permissions sur les tables (alternative au RLS)
-- Ces commandes permettent l'accès public aux tables pour votre application
GRANT ALL ON ALL TABLES IN SCHEMA public TO postgres, anon, authenticated, service_role;
GRANT ALL ON ALL SEQUENCES IN SCHEMA public TO postgres, anon, authenticated, service_role;
GRANT ALL ON ALL FUNCTIONS IN SCHEMA public TO postgres, anon, authenticated, service_role;

-- Permettre les insertions, mises à jour et suppressions
...
-- Politiques permissives pour l'application (accès complet)
CREATE POLICY "Enable all access for application" ON hotels FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Enable all access for application" ON merchants FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Enable all access for application" ON users FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Enable all access for application" ON clients FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Enable all access for application" ON products FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Enable all access for application" ON orders FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Enable all access for application" ON hotel_merchants FOR ALL USING (true) WITH CHECK (true);
